...
```{r}
# Load dataset
drought_pct <- readr::read_csv('https://raw.githubusercontent.com/rfordatascience/tidytuesday/main/data/2021/2021-07-20/drought_area_pct.csv')
```
...
```{r}
knitr::include_graphics("RData/Drought_data/United States Regions.png")
```
...
ggplot(drought_with_region, aes(x = ValidStart, y = D4, group = Region)) +
  ...
  geom_hline(yintercept = 20, linetype = "dashed", color = "darkred", size = 1) + 
  labs(
